...
// post 请求
// post("/api/order/paymentForAliPay", {}).then(res=>{
...
// 将图片添加为完整路径
// ["/uploads/1.phg","/uploads/1.phg"]
// getImageFullUrl(["/uploads/1.phg","/uploads/1.phg"])

// [{image:"/uploads/1.phg"},{image:"/uploads/1.phg"}]
// getImageFullUrl([{image:"/uploads/1.phg"},{image:"/uploads/1.phg"}], 'image')
